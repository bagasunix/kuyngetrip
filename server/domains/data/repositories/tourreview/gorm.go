...
func (g *gormProvider) Delete(ctx context.Context, id uuid.UUID) error {
	return err.ErrSomethingWrong(g.logs, g.db.WithContext(ctx).Delete(models.NewTourReviewBuilder().Build(), "id = ?", id).Error)
}

// GetAll implements Repository.
func (g *gormProvider) GetAll(ctx context.Context, limit int64) (result models.SliceResult[models.TourReview]) {
...
func (g *gormProvider) Updates(ctx context.Context, m models.TourReview) error {
