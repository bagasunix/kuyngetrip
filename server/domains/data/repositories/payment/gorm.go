...
func (g *gormProvider) Create(ctx context.Context, m models.Payment) error {
	return err.ErrDuplicateValue(g.logs, g.GetModelName(), g.db.WithContext(ctx).Create(&m).Error)
}

// GetAll implements Repository.
func (g *gormProvider) GetAll(ctx context.Context, limit int64) (result models.SliceResult[models.Payment]) {
...
func (g *gormProvider) GetById(ctx context.Context, id uuid.UUID) (result models.SingleResult[*models.Payment]) {
...
func (g *gormProvider) Updates(ctx context.Context, m models.Payment) error {
