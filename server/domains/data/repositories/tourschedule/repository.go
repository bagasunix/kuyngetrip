...
func (g *gormProvider) Create(ctx context.Context, m models.TourSchedule) error {
...
func (g *gormProvider) Delete(ctx context.Context, id uuid.UUID) error {
	return err.ErrSomethingWrong(g.logs, g.db.WithContext(ctx).Delete(models.NewTourScheduleBuilder().Build(), "id = ?", id).Error)
}

// GetAll implements Repository.
func (g *gormProvider) GetAll(ctx context.Context, limit int64) (result models.SliceResult[models.TourSchedule]) {
...
func (g *gormProvider) GetById(ctx context.Context, id uuid.UUID) (result models.SingleResult[*models.TourSchedule]) {
...
func (g *gormProvider) Updates(ctx context.Context, m models.TourSchedule) error {
